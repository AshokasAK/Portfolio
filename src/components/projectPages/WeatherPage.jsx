        ...
        <div className="singleContent">
          <div className="singlePro">
            ...
            <section>
              ...
              <h5>Details:</h5>
              <p>
                Weather App, it shows the weather of district.It was an simple
                Frontend with handling the api calls in a clear way.The project
                breakdowns,First we wnat to enter the district name ithe search
                bar,if there is any spelling mistake is detected then it shows
                the error in a userr friendly manner.So that the user can
                understand what mistake he has done.If the district matches the
                actual name then the results will be displayed to the user.
              </p>
            </section>
          </div>
